...
/**
 * \file    test/phpunit/ReyadaInventoriesFunctionalTest.php
...
/**
 * Class ReyadaInventoriesFunctionalTest
 *
 ...
 *
 * @package Testreyadainventories
 */
class ReyadaInventoriesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modReyadaInventories')->click();
		} else {
			// Disable the module
			$this->byHref('modReyadaInventories')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/reyadainventories/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('reyadainventories/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/reyadainventories/admin/about.php');
		$this->authenticate();
		return $this->assertContains('reyadainventories/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('reyadainventorieswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modReyadaInventories_ReyadaInventoriesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modReyadaInventories_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
